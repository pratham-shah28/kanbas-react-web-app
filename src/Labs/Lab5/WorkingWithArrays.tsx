...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <h3>Updating an Item in an Completed</h3>
    ...
    value='true' // Value for true
    checked={todo.completed === true} // Set default checked based on state
    onChange={(e) => setTodo({ ...todo, completed: e.target.value === "true" })}
  />
  <label className="form-check-label me-3" htmlFor="completedTrue">
    True
  </label>
  ...
  <input
    ...
    id="completedFalse"
    className="form-check-input"
    value='false' // Value for false
    checked={todo.completed === false} // Set default checked based on state
    onChange={(e) => setTodo({ ...todo, completed: e.target.value === "false" })}
  />
  <label className="form-check-label" htmlFor="completedFalse">
    False
  </label>
      <br /><br /><hr />

      <h3>Updating an Item in an Description</h3>
